...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // REMOVE OR COMMENT OUT THIS LINE (MariaDB/MySQL doesn't support it):
        // DB::statement("COMMENT ON TABLE victims IS 'Stores information about victims associated with abuse cases'");
    }
