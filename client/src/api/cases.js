// caseApi.js - UPDATED VERSION
import api from './index'

export const caseApi = {
  getCases: (params) => api.get('/cases', { params }),
  getCase: (id) => api.get(`/cases/${id}`),
  getCaseStats: (id) => api.get(`/cases/${id}/stats`),
  getCaseNotes: (id) => api.get(`/cases/${id}/notes`),
  ...
  deleteNote: (id, noteId) => api.delete(`/cases/${id}/notes/${noteId}`),
}